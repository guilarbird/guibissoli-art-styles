...
// Trilingual content for article body
const content = {
  title: {
    pt: 'Tick Size, Microestrutura e Liquidez Funcional',
    en: 'Tick Size, Microstructure and Functional Liquidity',
    zh: 'Tick Size、市场微观结构与功能性流动性',
  },
  subtitle: {
    pt: 'Como ajustes aparentemente técnicos redefinem o papel do mercado spot em stablecoins',
    en: 'How seemingly technical adjustments redefine the role of spot markets in stablecoins',
    zh: '看似技术性的调整如何重新定义稳定币现货市场的角色',
  },
  backLink: {
  ...
  executiveSummary: {
    ...
    text: {
      pt: 'A discussão recente sobre stablecoins, OTC e sandbox regulatório no Brasil tem avançado rapidamente no plano jurídico. No entanto, há uma variável estrutural menos visível — o tick size — que atua como determinante primário da eficiência do mercado spot. Este artigo argumenta que ajustes finos de microestrutura, em especial no tamanho mínimo de variação de preço, podem reduzir spreads de forma endógena, aumentar profundidade funcional do livro de ordens e diminuir a dependência estrutural de canais OTC.',
      en: 'The recent discussion about stablecoins, OTC and regulatory sandbox in Brazil has advanced rapidly on the legal front. However, there is a less visible structural variable — the tick size — that acts as a primary determinant of spot market efficiency. This article argues that fine microstructure adjustments, especially in minimum price variation, can endogenously reduce spreads, increase functional order book depth, and decrease structural dependence on OTC channels.',
      zh: '最近关于稳定币、场外交易和巴西监管沙盒的讨论在法律层面迅速推进。然而，有一个不太明显的结构性变量——tick size——它是现货市场效率的主要决定因素。本文认为，微观结构的精细调整，特别是最小价格变动幅度，可以内生性地降低价差，增加订单簿的功能性深度，并减少对场外交易渠道的结构性依赖。',
    },
  },
  sections: [
    {
      num: '01',
      title: {
        pt: 'Por que microestrutura voltou ao centro do debate',
        en: 'Why microstructure returned to the center of debate',
        zh: '为什么微观结构重新成为辩论的中心',
      },
      text: {
        pt: 'Mercados financeiros maduros raramente resolvem problemas de liquidez por meio de exceções permanentes. Historicamente, o caminho tem sido outro: calibração cuidadosa dos mecanismos de negociação. Parâmetros como prioridade preço-tempo, regras de cancelamento e, sobretudo, tamanho de tick sempre foram tratados como instrumentos centrais de governança econômica.',
        en: 'Mature financial markets rarely solve liquidity problems through permanent exceptions. Historically, the path has been different: careful calibration of trading mechanisms. Parameters such as price-time priority, cancellation rules, and especially tick size have always been treated as central instruments of economic governance.',
        zh: '成熟的金融市场很少通过永久性例外来解决流动性问题。历史上，路径一直是不同的：仔细校准交易机制。价格时间优先、取消规则，尤其是tick size等参数一直被视为经济治理的核心工具。',
      },
    },
    {
      num: '02',
      title: {
        pt: 'Tick size: um detalhe técnico com efeito macroeconômico',
        en: 'Tick size: a technical detail with macroeconomic effect',
        zh: 'Tick size：具有宏观经济效应的技术细节',
      },
      text: {
        pt: 'O tick size define o menor incremento admissível de preço em um livro de ordens contínuo. Embora pareça um detalhe operacional, ele atua como um limitador estrutural da competição. Quando o tick é grande demais, o spread deixa de refletir risco ou informação e passa a refletir apenas o grid permitido. Quando o tick é excessivamente pequeno, o mercado entra em um regime de micro-ruído.',
        en: 'Tick size defines the smallest allowable price increment in a continuous order book. Although it seems like an operational detail, it acts as a structural limiter of competition. When the tick is too large, the spread stops reflecting risk or information and starts reflecting only the allowed grid. When the tick is excessively small, the market enters a micro-noise regime.',
        zh: 'Tick size定义了连续订单簿中允许的最小价格增量。虽然它看起来像是一个操作细节，但它实际上是竞争的结构性限制器。当tick太大时，价差不再反映风险或信息，而只反映允许的网格。当tick过小时，市场进入微噪声状态。',
      },
      hasDiagram: true,
      diagramCaptions: {
        left: {
          pt: 'Tick fino: fragmentação e micro-ruído',
          en: 'Fine tick: fragmentation and micro-noise',
          zh: '细小tick：碎片化和微噪声',
        },
        right: {
          pt: 'Tick calibrado: consolidação e profundidade',
          en: 'Calibrated tick: consolidation and depth',
          zh: '校准tick：整合和深度',
        },
      },
    },
    {
      num: '03',
      title: {
        pt: 'A forma do book importa mais que o topo do book',
        en: 'The shape of the book matters more than the top of the book',
        zh: '订单簿的形状比订单簿的顶部更重要',
      },
      text: {
        pt: 'Avaliações superficiais de liquidez costumam se concentrar no best bid/ask. Para fluxos institucionais, isso é insuficiente. O que importa é a geometria completa do livro de ordens. Para FX e pagamentos, previsibilidade domina preço pontual.',
        en: 'Superficial liquidity assessments usually focus on best bid/ask. For institutional flows, this is insufficient. What matters is the complete geometry of the order book. For FX and payments, predictability dominates point price.',
        zh: '表面的流动性评估通常集中在最佳买卖价。对于机构流量来说，这是不够的。重要的是订单簿的完整几何形状。对于外汇和支付，可预测性优于即时价格。',
      },
    },
    {
      num: '04',
      title: {
        pt: 'OTC como sintoma de falha estrutural',
        en: 'OTC as a symptom of structural failure',
        zh: '场外交易作为结构性失败的症状',
      },
      text: {
        pt: 'OTC surge quando o mercado contínuo falha simultaneamente em três dimensões: preço, tamanho e previsibilidade. OTC não cria liquidez. Ele apenas realoca custo e risco fora do mercado organizado.',
        en: 'OTC emerges when the continuous market fails simultaneously in three dimensions: price, size, and predictability. OTC does not create liquidity. It only reallocates cost and risk outside the organized market.',
        zh: '当连续市场在三个维度同时失败时，场外交易就会出现：价格、规模和可预测性。场外交易不创造流动性。它只是将成本和风险重新分配到有组织的市场之外。',
      },
      hasOtcDiagram: true,
      otcCaption: {
        pt: 'Fluxo OTC: realocação de custo e risco fora do mercado organizado',
        en: 'OTC flow: cost and risk reallocation outside organized market',
        zh: 'OTC流程：成本和风险在有组织市场之外的重新分配',
      },
    },
    {
      num: '05',
      title: {
        pt: 'Evidência empírica: mudança de regime no USDT/BRL',
        en: 'Empirical evidence: regime change in USDT/BRL',
        zh: '实证证据：USDT/BRL的制度变化',
      },
      text: {
        pt: 'Após ajustes recentes no tick size do par USDT/BRL, observou-se compressão estrutural do spread, consolidação de liquidez útil, redução do slippage acumulado e maior estabilidade intraday.',
        en: 'After recent adjustments to the USDT/BRL tick size, structural spread compression was observed, useful liquidity consolidation, reduced accumulated slippage, and greater intraday stability.',
        zh: '在最近调整USDT/BRL的tick size后，观察到结构性价差压缩、有用流动性整合、累积滑点减少以及更大的日内稳定性。',
      },
      hasSlippageDiagram: true,
      slippageCaption: {
        pt: 'Curva de slippage: antes e depois do ajuste de tick size',
        en: 'Slippage curve: before and after tick size adjustment',
        zh: '滑点曲线：tick size调整前后',
      },
    },
    {
      num: '06',
      title: {
        pt: 'Tick size como instrumento de governança',
        en: 'Tick size as a governance instrument',
        zh: 'Tick size作为治理工具',
      },
      text: {
        pt: 'Bolsas tradicionais sempre trataram tick size como instrumento de governança de mercado. À medida que stablecoins se aproximam do universo de FX e pagamentos, a microestrutura deixa de ser neutra.',
        en: 'Traditional exchanges have always treated tick size as a market governance instrument. As stablecoins approach the FX and payments universe, microstructure ceases to be neutral.',
        zh: '传统交易所一直将tick size视为市场治理工具。随着稳定币接近外汇和支付领域，微观结构不再是中性的。',
      },
    },
    {
      num: '07',
      title: {
        pt: 'Convergência com o espírito regulatório',
        en: 'Convergence with regulatory spirit',
        zh: '与监管精神的趋同',
      },
      text: {
        pt: 'O movimento regulatório recente no Brasil, incluindo a Resolução BCB 521, aponta para maior previsibilidade e redução de arbitragens opacas. Tick size bem calibrado comprime spreads de forma natural, reduz dependência estrutural de OTC e melhora qualidade da formação de preço.',
        en: 'The recent regulatory movement in Brazil, including BCB Resolution 521, points to greater predictability and reduction of opaque arbitrages. Well-calibrated tick size naturally compresses spreads, reduces structural OTC dependence, and improves price formation quality.',
        zh: '巴西最近的监管动向，包括BCB第521号决议，指向更大的可预测性和减少不透明套利。校准良好的tick size自然压缩价差，减少结构性场外交易依赖，并改善价格形成质量。',
      },
    },
    {
      num: '08',
      title: {
        pt: 'Implicações para investidores e formuladores de política',
        en: 'Implications for investors and policy makers',
        zh: '对投资者和政策制定者的影响',
      },
      text: {
        pt: 'Para PE, VC e policy makers, o tick size funciona como leading indicator de maturidade institucional. Plataformas que dominam microestrutura escalam com menor custo marginal, atraem fluxo institucional e enfrentam menor risco regulatório.',
        en: 'For PE, VC and policy makers, tick size functions as a leading indicator of institutional maturity. Platforms that master microstructure scale with lower marginal cost, attract institutional flow, and face lower regulatory risk.',
        zh: '对于PE、VC和政策制定者来说，tick size是机构成熟度的领先指标。掌握微观结构的平台以较低的边际成本扩展，吸引机构流量，并面临较低的监管风险。',
      },
    },
  ],
  conclusion: {
    ...
    text: {
      pt: 'À medida que o mercado brasileiro discute stablecoins, OTC e sandbox, o próximo passo natural é voltar ao fundamento. Se 2026 marcar a consolidação do FX digital no Brasil, a microestrutura não será detalhe — será pré-condição.',
      en: 'As the Brazilian market discusses stablecoins, OTC and sandbox, the next natural step is to return to fundamentals. If 2026 marks the consolidation of digital FX in Brazil, microstructure will not be a detail — it will be a precondition.',
      zh: '随着巴西市场讨论稳定币、场外交易和沙盒，下一个自然步骤是回归基本面。如果2026年标志着巴西数字外汇的整合，微观结构将不是细节——而是前提条件。',
    },
  },
  appendix: {
    title: {
      pt: 'Apêndice: Comparativo de Políticas',
      en: 'Appendix: Policy Comparison',
      zh: '附录：政策比较',
    },
    headers: {
      dimension: { pt: 'Dimensão', en: 'Dimension', zh: '维度' },
      otcCentric: { pt: 'OTC-cêntrico', en: 'OTC-centric', zh: 'OTC为中心' },
      microCentric: { pt: 'Microestrutura-cêntrico', en: 'Microstructure-centric', zh: '微观结构为中心' },
    },
    rows: [
      {
        dimension: { pt: 'Transparência', en: 'Transparency', zh: '透明度' },
        otc: { pt: 'Baixa', en: 'Low', zh: '低' },
        micro: { pt: 'Alta', en: 'High', zh: '高' },
      },
      {
        dimension: { pt: 'Escalabilidade', en: 'Scalability', zh: '可扩展性' },
        otc: { pt: 'Limitada', en: 'Limited', zh: '有限' },
        micro: { pt: 'Alta', en: 'High', zh: '高' },
      },
      {
        dimension: { pt: 'Risco regulatório', en: 'Regulatory risk', zh: '监管风险' },
        otc: { pt: 'Alto', en: 'High', zh: '高' },
        micro: { pt: 'Baixo', en: 'Low', zh: '低' },
      },
      {
        dimension: { pt: 'Formação de preço', en: 'Price formation', zh: '价格形成' },
        otc: { pt: 'Opaca', en: 'Opaque', zh: '不透明' },
        micro: { pt: 'Transparente', en: 'Transparent', zh: '透明' },
      },
    ],
  },
  authorBio: {
    pt: 'Construindo infraestrutura financeira para o Global South. Director @ Coins.xyz Brasil.',
    en: 'Building financial infrastructure for the Global South. Director @ Coins.xyz Brazil.',
    zh: '为全球南方构建金融基础设施。Coins.xyz巴西总监。',
  },
  footer: {
      ...
      <div className="border-b border-border">
        <div className="max-w-4xl mx-auto px-8 py-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-6 text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              <Headphones size={14} />
              <span className="meta-mono text-sm">{content.audioAvailable[lang]}</span>
            </div>
          </div>
          
          <div className="flex items-center gap-4">
            <span className="text-sm text-muted-foreground">Share:</span>
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(content.title[lang])}&url=${encodeURIComponent(window.location.href)}`} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
              <Twitter size={18} />
            </a>
            <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(window.location.href)}`} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
              <Linkedin size={18} />
            </a>
          </div>
        </div>
        ...
        >
          ...
          <section className="mb-16">
            <div className="border-l-4 border-primary pl-6 py-2">
              <h2 className="font-display text-2xl font-semibold mb-4 text-foreground">
                {content.executiveSummary.title[lang]}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {content.executiveSummary.text[lang]}
              </p>
            </div>
          </section>
          ...
          {content.sections.map((section, index) => (
            <section key={index} className="mb-12">
              <h2 className="font-display text-2xl font-semibold mb-6 text-foreground flex items-center gap-3">
                <span className="text-primary meta-mono text-lg">{section.num}</span>
                {section.title[lang]}
              </h2>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-card/50 border border-border rounded-lg p-4">
                      ...
                      <figcaption className="mt-3 text-sm text-muted-foreground meta-mono text-center">
                        {section.diagramCaptions?.left[lang]}
                      </figcaption>
                    </div>
                    <div className="bg-card/50 border border-border rounded-lg p-4">
                      <img 
                      ...
                      />
                      <figcaption className="mt-3 text-sm text-muted-foreground meta-mono text-center">
                        {section.diagramCaptions?.right[lang]}
                      </figcaption>
                    </div>
                  </div>
                </figure>
              ...
              {/* OTC Diagram for Section 4 */}
              {section.hasOtcDiagram && (
                <figure className="my-8">
                  <div className="bg-card/50 border border-border rounded-lg p-4">
                    <img 
                    ...
                    />
                    <figcaption className="mt-3 text-sm text-muted-foreground meta-mono text-center">
                      {section.otcCaption?.[lang]}
                    </figcaption>
                  </div>
                </figure>
              )}
              
              {/* Slippage Diagram for Section 5 */}
              {section.hasSlippageDiagram && (
                <figure className="my-8">
                  <div className="bg-card/50 border border-border rounded-lg p-4">
                    <img 
          ...
          <section className="mb-12 bg-card/30 border border-border rounded-lg p-8">
            <h2 className="font-display text-xl font-semibold mb-6 text-foreground">
              {content.appendix.title[lang]}
            </h2>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 text-muted-foreground meta-mono font-normal">{content.appendix.headers.dimension[lang]}</th>
                    <th className="text-left py-3 px-4 text-muted-foreground meta-mono font-normal">{content.appendix.headers.otcCentric[lang]}</th>
                    <th className="text-left py-3 px-4 text-muted-foreground meta-mono font-normal">{content.appendix.headers.microCentric[lang]}</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  {content.appendix.rows.map((row, index) => (
                    <tr key={index} className={index < content.appendix.rows.length - 1 ? "border-b border-border/50" : ""}>
                      <td className="py-3 px-4">{row.dimension[lang]}</td>
                      <td className="py-3 px-4">{row.otc[lang]}</td>
                      <td className="py-3 px-4 text-primary">{row.micro[lang]}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
